...
import com.example.PhaseTwo.model.email.EmailSender;
...
import com.example.PhaseTwo.model.service.impl.UserServiceImpl;
...
public class RegistrationService {
    ...
    public RegistrationService(UserServiceImpl appUserService, EmailValidator emailValidator, ConfirmationTokenService confirmationTokenService, EmailSender emailSender) {
    ...
    public String register(Users user) {
       ...
       Users users= new Users();
        ...
        String token = appUserService.signUpUser(users);
